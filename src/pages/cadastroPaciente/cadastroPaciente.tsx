                ...
                <div className='formulario'>
                    ...
                    {step === 1 ? (
                        <>
                            ...
                            <InputTotal label="CPF" pleaceHolder="Digite seu cpf..." tipo='text' value={cpf} onChange={(e) => { const value = e.target.value.replace(/\D/g, ''); if (value.length <= 11) {setCpf(value); }}}/>
                        ...
                        <>
                            ...
                            <div className="input-pair">
                                ...
                                <InputMedio label="Complemento:" pleaceHolder="Digite o complemento..." value={complemento} onChange={(e) => setComplemento(e.target.value)} tipo='text' />
                            </div>
                            <div className="input-pair">
                                <InputMedio label="Cidade:" pleaceHolder="Digite a cidade..." value={cidade} onChange={(e) => setCidade(e.target.value)} tipo='text' />
                                <InputMedio label="Estado:" pleaceHolder="Digite o estado..." value={estado} onChange={(e) => setEstado(e.target.value)} tipo='text' />
                            </div>
                            <div className="input-pair">
                                <InputMedio label="Pais:" pleaceHolder="Digite o pais..." value={pais} onChange={(e) => setPais(e.target.value)} tipo='text' />
                                <div className="input-wrapper">
                                    <Select label='Genero: ' value={genero} options={generos} onChange={handleSelectChange} />
                                </div>
                            </div>
