...
export default function Cadastro() {
    ...
    const handleClick = () => {
        if (step === 1) {
            if (!nome || !email || !cpfValue || !senha || !senhaC || !crp) {
            ...
            if (!validarCRP(crp)) {
                apresentarErro('CRP inválido. Use o formato "XX/000000" com até 6 dígitos no número de registro.');
                return;
            }
    ...
    return (
        <div className="login-container">
            <div className="left-content">
                <img src="../../src/assets/CadastroPsicologo.svg" alt="login psicologo" className='imagem'/>
            </div>
                    ...
                    {step === 1 ? (
                        <>
                            ...
                            <InputTotal
                                ...
                                value={crp}
                                onChange={(e) => {
                                    const formatado = formatarCRP(e.target.value);
                                    setCrp(formatado);
                                }}
                            />
                        </>
