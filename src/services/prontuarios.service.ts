...
export function consultaProntuariosPsicologo(idPsicologo: string, page: number): Promise<Response<Page<ProntuarioModel>>> {
    return axios.get<Response<Page<ProntuarioModel>>>(
